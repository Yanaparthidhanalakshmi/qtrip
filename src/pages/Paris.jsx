...
function Paris(){
    ...
    useEffect(()=>{
        let paris=fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures?city=paris")
        paris.then(x=>x.json()).then(val=>{
            // console.log(val);
            setapi1(val)
